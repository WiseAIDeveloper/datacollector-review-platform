...
- Batch filter colours reflect capture progress: grey for not started, light blue
  for in progress, light green for completed, and yellow for excess. Excess takes
  priority and uses yellow highlights throughout the dashboard.
